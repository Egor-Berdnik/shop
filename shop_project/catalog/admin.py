...
from catalog.models import Category, Cashback, Producer, Discount, Product, Promocode, Order, OrderProducts
...
class ProductAdmin(admin.ModelAdmin):
    ...
    search_fields = ('name', 'articul', 'category__name', 'producer__name', 'producer__country')
...
class OrderAdmin(admin.ModelAdmin):
    list_display = ('id', 'date_created', 'user', 'result_price', 'delivery_status', 'payment_status')
